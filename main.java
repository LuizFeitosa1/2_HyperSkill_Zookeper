        ...
        while(true){
            ...
            if(input.equals("exit")){
                ...
                try{
                    ...
                    if(habitatNumber > animals.length-1 || habitatNumber < 0){
                        System.out.println("Habitat doesn't exist, please enter a valid habitat number.");
                    }else{
                        System.out.println(animals[habitatNumber]);
                    }
                }catch(Exception e){
                    System.out.println("Please enter a valid habitat number.");
                }
            }
        }
        sc.close();
